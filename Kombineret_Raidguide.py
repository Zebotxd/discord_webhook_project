...
# --- Indhold fra Forventninger_og_Krav.py ---
forventninger_krav_text = """
**Raidtider og Mål**
...
# Tilføj det første felt med indholdet fra Forventninger_og_Krav-guiden
main_embed.add_field(
    name="**Forventninger og Krav**",
    value=forventninger_krav_text,
    inline=False
)

# Tilføj det andet felt med indholdet fra Loot-guiden
main_embed.add_field(
    name="**Lootregler**",
    value=loot_text,
    inline=False
